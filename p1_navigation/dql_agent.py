# In the first iteration it is basically copy, paste & adapt from the lunar lander mini project

import numpy as np
import random
from collections import namedtuple, deque

from dql_network import DQNetwork
...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed = 19710811):
